        ...
        <div className="">
          <div className="flex flex-col sm:flex-row sm:gap-12 py-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center justify-evenly py-4">
                <button className="text-white w-28 py-2 flex items-center justify-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer">
                  Demo
                </button>
                <button className="text-white w-28 py-2 flex items-center justify-center rounded-md bg-gradient-to-r from-cyan-500 to-blue-500 cursor-pointer">
                  Code
          ...
          <div className="flex flex-col sm:flex-row sm:gap-12 py-8">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-1xl ">
                Track your coin using crypto-tracker and  you can buy sell the coin any time on this
                platform.
              </p>
              <ul className="py-4 text-slate-400">
                <li className="flex items-center gap-1 justify-start">
